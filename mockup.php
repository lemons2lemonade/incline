...
<nav class="navbar navbar-default navbar-static-top">
  ...
  <a href="signup.php"> <i class = "fa fa-drivers-license-o">Account</i></a>
...
<div class= "well">
  <div id = "formContainer">
    <form name="post" id= "post_text" action="send_posts.php" method= "post">
<div class= "col-lg-4 col-lg-offset-4">
 <div class="form-group">
  <label for="content-box">Go on...</label>
<button class="btn" onclick="validateTextBox()" name ="submit" type="submit"> <i class="fa fa-send-o"></i> </button>
  <textarea class="form-control" rows="5" type="text" name="content" id="text"></textarea>
</form>
</div>
</div> 
</div>
